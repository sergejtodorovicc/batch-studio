            ...
            >
              ...
              <div className="grid grid-cols-2 gap-6 max-w-lg">
                ...
                <div className="relative rounded-xl overflow-hidden border border-accent/30">
                  <div style={{ height: 180, background: 'linear-gradient(135deg, #150E09, #0A0705)' }}
                    className="flex items-center justify-center">
                    <span className="text-accent text-xs font-mono">Human-polished ✓</span>
                  </div>
                  <div className="absolute bottom-0 inset-x-0 p-3" style={{ background: 'rgba(212,137,26,0.05)' }}>
                  ...
                  {graphData.map((h, i) => (
                    <div key={i} className="flex-1 flex flex-col items-center gap-1">
                      <div
                        ...
                        style={{
                          height: `${h}%`,
                          background: i === graphData.length - 1 ? 'var(--accent)' : 'rgba(212,137,26,0.25)',
                          transform: 'scaleY(0)',
